...
function normalizeSpace($str) {
	return (0, _xvtype.seq)((0, _xvtype._first)($str).replace(/^[\x20\x9\xD\xA]+|[\x20\x9\xD\xA]+$/g, "").replace(/[\x20\x9\xD\xA]+/g, " "));
}
...
function stringLength($str) {
	...
	return (0, _xvtype.seq)(str !== undefined ? str.replace(regexAstralSymbols, "_").toString().length : 0);
}
...
function normalizeUnicode($str, $form) {
	var str = (0, _xvtype._first)($str);
	var form = (0, _xvtype._first)($form);
	return !str ? (0, _xvtype.seq)() : (0, _xvtype.seq)(!form ? str.normalize() : str.normalize(form.toUpperCase()));
}