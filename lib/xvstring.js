...
function stringLength($str) {
	var str = (0, _xvseq._first)($str);
	return (0, _xvseq.seq)(str.length);
}

function stringJoin($seq, $sep) {
	var sep = (0, _xvseq._first)($sep);
	return (0, _xvseq.seq)((0, _xvtype.string)($seq).join(sep !== undefined ? sep : ""));
}
...
function concat() {
	...
	return (0, _xvseq.seq)((0, _xvtype.string)((0, _xvseq.toSeq)(a)).flatten(true).join(""));
}